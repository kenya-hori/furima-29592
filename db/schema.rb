...
ActiveRecord::Schema.define(version: 2021_03_18_102706) do
  ...
  create_table "buyer_infos", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchase_history_id"], name: "index_buyer_infos_on_purchase_history_id"
  end
  ...
  add_foreign_key "buyer_infos", "purchase_histories"
